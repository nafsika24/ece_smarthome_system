...
# Data production for window event :
# topic : topic/window
...
rooms = ["bathroom", "kitchen", "bedroom", "living room"]
...
while 1 :
    ...
    if not int(now.strftime("%M")) % 5 :
        ...
        for room in rooms :
            ...
            client.publish("topic/window", str(json.dumps(current_payload, indent = 4)))
